...
Configuration in this directory create a policy that allow to full access ECS service and deny to create or update or delete security groups.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/EcsFullAccessDenySecurityChange | n/a |
