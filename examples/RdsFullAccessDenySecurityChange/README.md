...
Configuration in this directory create a policy that allow to full access RDS service and deny to modify security settings.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/RdsFullAccessDenySecurityChange | n/a |
