...
Configuration in this directory create a policy that allow to list all domains and manage specified domains.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/AlidnsDomainFullAccess | n/a |
