...
Configuration in this directory create a policy that allow to list all ECS instances, run and stop commands on instances.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/EcsInstanceRunCommand | n/a |
