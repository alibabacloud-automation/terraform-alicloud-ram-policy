...
Configuration in this directory create a policy that allow to list and view specified ACK clusters.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/AckClusterFullAccess | n/a |
