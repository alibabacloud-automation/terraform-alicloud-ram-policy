...
Configuration in this directory create a policy that allow to access specified AHAS applications.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/AhasApplicaitonReadOnly | n/a |
