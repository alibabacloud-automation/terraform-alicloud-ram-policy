...
Configuration in this directory create a policy that allow to list all Redis instances, create account and reset password and modify securify IPs.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/RedisDbInstanceAccount | n/a |
