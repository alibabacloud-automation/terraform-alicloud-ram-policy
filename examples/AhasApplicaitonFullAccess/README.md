...
Configuration in this directory create a policy that allow to access specified AHAS applications and authorize AHAS.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/AhasApplicaitonFullAccess | n/a |
