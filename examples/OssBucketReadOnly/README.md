...
Configuration in this directory create a policy that allow to access resources of specified OSS bucket.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/OssBucketReadOnly | n/a |
