...
Configuration in this directory create a policy for auditing administrator, who can access Cloud Config, ActionTrail, SLS and describe all cloud resources.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/AuditAdministrator | n/a |
