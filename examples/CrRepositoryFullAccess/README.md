...
Configuration in this directory create a policy that allow to full access specified ACR repositories.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/CrRepositoryFullAccess | n/a |
