...
Configuration in this directory create a policy that allow MaxCompute to access specified OSS Bucket.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/MaxComputeAccessOSSBucket | n/a |
