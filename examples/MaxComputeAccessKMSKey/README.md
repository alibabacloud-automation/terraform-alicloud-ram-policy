...
Configuration in this directory create a policy that allow MaxCompute to encrypt or decrypt with specified KMS key.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/MaxComputeAccessKMSKey | n/a |
