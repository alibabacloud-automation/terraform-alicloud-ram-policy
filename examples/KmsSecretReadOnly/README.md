...
Configuration in this directory create a policy that allow to list and view all KMS secrets.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/KmsSecretReadOnly | n/a |
