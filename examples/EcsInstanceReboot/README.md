...
Configuration in this directory create a policy that allow to list all ECS instances and reboot specified instances.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/EcsInstanceReboot | n/a |
