...
Configuration in this directory create a policy that allow to post log to specified SLS project.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/PostLogToSlsProject | n/a |
