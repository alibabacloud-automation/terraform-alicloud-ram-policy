...
Configuration in this directory create a policy that allow to list all CR namespaces and pull repositories of specified namespaces.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/CrRepositoryPull | n/a |
