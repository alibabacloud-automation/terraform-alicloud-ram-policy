...
Configuration in this directory create a policy that allow to full access resources of specified OSS buckets and deny to delete any.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/OssBucketFullAccessDenyDelete | n/a |
