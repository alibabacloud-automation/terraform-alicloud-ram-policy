...
Configuration in this directory create a policy that allow to full access Redis service and deny to buy and renew and modify spec.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_example"></a> [example](#module\_example) | ../../modules/RedisFullAccessDenyBuy | n/a |
