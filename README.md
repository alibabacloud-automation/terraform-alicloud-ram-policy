...
| Name | Description |
|------|-------------|
| <a name="output_this_policy_id"></a> [this\_policy\_id](#output\_this\_policy\_id) | Id of the custom policy. |
| <a name="output_this_policy_name"></a> [this\_policy\_name](#output\_this\_policy\_name) | Name of the custom policy. |
<!-- END_TF_DOCS -->
