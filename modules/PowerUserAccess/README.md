...
Create a policy for power user, who is responsible for enterprise cloud operation, can create and view and operate all cloud services, can NOT manage identity permissions, can NOT manage account structure, can NOT use financial center.

```hcl
module "example" {
  source = "terraform-alicloud-modules/ram-policy/alicloud//modules/PowerUserAccess"
}
```
...
| <a name="input_description"></a> [description](#input\_description) | The description of the policy | `string` | `"Power user, who is responsible for enterprise cloud operation, can create and view and operate all cloud services, can NOT manage identity permissions, can NOT manage account structure, can NOT use financial center."` | no |
| <a name="input_policy_name"></a> [policy\_name](#input\_policy\_name) | The name of the policy | `string` | `"PowerUserAccess"` | no |
