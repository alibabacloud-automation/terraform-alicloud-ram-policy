...
```hcl
module "example" {
  source = "terraform-alicloud-modules/ram-policy/alicloud//modules/CrRepositoryPull"
  cr_namespace = "ns1"
}
```
...
| <a name="input_description"></a> [description](#input\_description) | The description of the policy | `string` | `"Allow to list all CR namespaces and pull repositories of specified namespaces."` | no |
| <a name="input_policy_name"></a> [policy\_name](#input\_policy\_name) | The name of the policy | `string` | `"CrRepositoryPull"` | no |
