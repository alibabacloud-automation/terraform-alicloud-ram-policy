...
Create a policy that allow to view and export orders and billing.
...
| <a name="input_description"></a> [description](#input\_description) | The description of the policy | `string` | `"Allow to view and export orders and billing."` | no |
| <a name="input_policy_name"></a> [policy\_name](#input\_policy\_name) | The name of the policy | `string` | `"BssReadOnly"` | no |
